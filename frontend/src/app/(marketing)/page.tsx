      ...
      <footer className="bg-white/60 backdrop-blur-md pt-20 pb-10 border-t-8 border-white rounded-t-[60px]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-10 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-4 font-bold text-brand-text mb-6">
                <li><i className="fas fa-envelope"></i> herufidiyanto1@gmail.com</li>
                <li>
                  <a href="https://wa.me/6282114752228" target="_blank" rel="noopener noreferrer" className="hover:text-brand-shadow transition">
                    <i className="fab fa-whatsapp"></i> +62 821-1475-2228
                  </a>
                </li>
              </ul>
          ...
          <div className="border-t-4 border-white pt-8 text-center text-brand-text font-bold">
            <p className="mb-2">© {new Date().getFullYear()} Ramadhan Ceria. Hak Cipta Dilindungi.</p>
            <p className="text-sm font-medium">
              Dikembangkan dengan <i className="fas fa-heart text-red-500 animate-pulse"></i> oleh{' '}
              <a
                href="https://herufidiyanto.netlify.app/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-brand-btn hover:text-brand-shadow transition decoration-2 underline-offset-4 underline"
              >
                Heru Fidiyanto
              </a>
            </p>
